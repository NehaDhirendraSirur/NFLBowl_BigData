...
public class re_mapper extends Mapper<Object, Text, Text, IntWritable> {
    ...
    public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
        ...
        int hadDropped = Integer.parseInt(fields[15]); // Assuming 4th column is hadDropped
        int sumOfPassingYards = Integer.parseInt(fields[16]); // Assuming 5th column is sum of passing yards
